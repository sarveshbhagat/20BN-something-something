...
ROOT_DATASET = '/home/ec2-user/SageMaker/Project/data/something/v2/'
...
def return_something(modality):
    ...
    if modality == 'RGB':
        ...
        root_data = ROOT_DATASET + '/20bn-something-something-v1-flow'
...
def return_somethingv2(modality):
    filename_categories = '/home/ec2-user/SageMaker/Project/data/something/v2/category.txt'
    if modality == 'RGB':
        #root_data = ROOT_DATASET + 'something/v2/20bn-something-something-v2-frames'
        # Project/data/20bn-something-something-v2-frames
        root_data = '/home/ec2-user/SageMaker/Project/data/something/v2/20bn-something-something-v2-frames'
        filename_imglist_train = '/home/ec2-user/SageMaker/Project/data/something/v2/train_videofolder.txt'
        filename_imglist_val = '/home/ec2-user/SageMaker/Project/data/something/v2/val_videofolder.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_DATASET + '/home/ec2-user/SageMaker/Project/data/something/v2/20bn-something-something-v2-flow'
        filename_imglist_train = '/home/ec2-user/SageMaker/Project/data/something/v2/train_videofolder_flow.txt'
        filename_imglist_val = '/home/ec2-user/SageMaker/Project/data/something/v2/val_videofolder_flow.txt'
        prefix = '{:06d}.jpg'
    else:
        raise NotImplementedError('no such modality:'+modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
