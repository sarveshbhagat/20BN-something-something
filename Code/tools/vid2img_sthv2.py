...
NUM_THREADS = 100
VIDEO_ROOT = '/home/ec2-user/SageMaker/Project/data/20bn-something-something-v2'         # Downloaded webm videos
FRAME_ROOT = '/home/ec2-user/SageMaker/Project/data/20bn-something-something-v2-frames'  # Directory for extracted frames
