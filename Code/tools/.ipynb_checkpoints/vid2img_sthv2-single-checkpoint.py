...
NUM_THREADS = 100
VIDEO_ROOT = '/home/ec2-user/SageMaker/Project/data/single'         # Downloaded webm videos
FRAME_ROOT = '/home/ec2-user/SageMaker/Project/data/single-frames'  # Directory for extracted frames
